    ...
    return (
        ...
        >
            <div className="relative group">
                ...
                <form onSubmit={handleSubmit} className="relative flex items-center bg-transparent backdrop-blur-xl border notion-whisper-border rounded-full p-2 shadow-deep hover:shadow-deep transition-all duration-300">
                    <div className="pl-5 text-[#615d59]">
                        <Link2 size={20} />
                    </div>
                    <input
                        type="text"
                        ...
                        className="flex-1 bg-transparent border-none outline-none text-[rgba(0,0,0,0.95)] placeholder-muted-foreground px-4 py-3 text-lg"
                        disabled={isQueueFull}
                    />
                    <button
                        type="submit"
                        disabled={isQueueFull || !url}
                        className="bg-[#0075de] hover:bg-[#0075de]/90 text-white px-8 py-3 rounded-full font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 shadow-soft-card hover:shadow-deep hover:-translate-y-0.5 active:translate-y-0"
                    >
                        <span>新增</span>
                        <ArrowRight size={18} />
                    </button>
            ...
            {/* Helper Text */}
            <div className="mt-6 flex justify-center gap-8 text-sm text-[#615d59]/80">
                ...
                <span className="flex items-center gap-2 transition-colors hover:text-[rgba(0,0,0,0.95)]"><span className="w-1.5 h-1.5 rounded-full bg-foreground/50"></span>Threads</span>
            </div>
        </motion.div>
    );
};
