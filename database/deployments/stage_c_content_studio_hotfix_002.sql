-- Hotfix 002: use the named evidence unique constraint to avoid a PL/pgSQL result-column collision.
-- Run once only after stage_c_content_studio_hotfix_001.sql has been applied.
